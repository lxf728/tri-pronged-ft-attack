def get_model(model_name_or_path, model_kwargs, model_family='llama2', padding_side = "right"):
    ...
    if model_family == 'llama2':
        ...
        from .model_families.qwen2_5 import initializer as qwen2_5_initializer
        return qwen2_5_initializer(model_name_or_path, model_kwargs, padding_side=padding_side)
    else:
